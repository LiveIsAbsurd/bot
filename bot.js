...
const setAuthority = (msg, state) => {
  ...
  bot.sendMessage(msg.chat.id, `Авторитет ${state.userMessage.userFirstName} - ${state.userMessage[msg.reply_to_message.from.id].authority} (+1) `, {reply_to_message_id: msg.message_id});
};
