...
+${chatState.messageOnDate[realDateGlobal].totalMessage}
`, {
...
const nyTrigger = ['новым годом', 'наступающем', 'нг', 'рождеством', 'наступившим', 'нового года', 'новом году', 'рождества', 'с праздником', 'новый год']
